...
<!-- <form method="POST" id="HPersonneForm"> -->
<div id="liste">
...
<%-- 				<td><input type="hidden" name="inputId" value="<c:out value='${personne.id}'/>"/></td> --%>
...
<!-- 				<td><input type="submit" name="delete" id="actionDeleteDansForm" value="Supprimer"/></TD> -->
			</TR>
		</c:forEach>
	  </TBODY>
	</TABLE>
...
onclick="myFunction()" 
           ...
           <input type="submit" name="delete" id="actionDeleteDansForm" value="Supprimer"/>
